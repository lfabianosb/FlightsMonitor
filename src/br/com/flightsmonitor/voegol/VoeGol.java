package br.com.flightsmonitor.voegol;
...
import br.com.flightsmonitor.voegol.exception.FlightNotFoundException;
import br.com.flightsmonitor.voegol.exception.SearchException;
...
public class VoeGol {
	...
	private static final long THRESHOLD_PRICE = 1000;
	
//	private static Locale locale =  Locale.getDefault();
//	private static DecimalFormat df = new DecimalFormat("#,##0.00", new DecimalFormatSymbols(locale));
	...
	//Pesquisar
	private Document search(HttpPost post) throws SearchException {
	...
	private BigDecimal findMinorPrice(Document document) throws FlightNotFoundException {
	...
	private boolean isGoodPrice(BigDecimal price) {
